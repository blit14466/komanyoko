...
TELEGRAM_TOKEN = '7463005137:AAEGxU-lAGoaR1SocqiQwPFqVQMBYijMULo7463005137:AAEGxU-lAGoaR1SocqiQwPFqVQMBYijMULo'
CHAT_ID = '6737143224'
...
while True:
    ...
    sleep(1)  # Sleep to avoid overloading the server or rate-limiimport os
import requests
import telebot
import hashlib
import base58
